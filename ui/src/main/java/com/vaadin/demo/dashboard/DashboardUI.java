...
public final class DashboardUI extends UI {
     ...
     */
    private void updateContent(boolean init) {
        ...
        if (user != null && "admin".equals(user.getRole())) {
            ...
            if (!init) {
                ...
                //    "Proble with authentication");
                //notification
                //    .setDescription("<span>Entered credentials are not valid</span>");
                
                Notification notification = new Notification("Error", "Entered credentials are not valid",
